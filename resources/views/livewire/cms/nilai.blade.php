                                            ...
                                            <tbody>
                                                @forelse($get_detail as $d)
                                                    <tr>
                                                        ...
                                                        <td><input type="text" class="form-control" value="{{ $d->nilai_keterampilan }}" wire:change="saveKeterampilan({{ $d->id }}, $event.target.value)"></td>
                                                        <td><input type="text" class="form-control" value="{{ $d->kebersihan }}" wire:change="saveKebersihan({{ $d->id }}, $event.target.value)"></td>
                                                        <td><input type="text" class="form-control" value="{{ $d->sikap }}" wire:change="saveSikap({{ $d->id }}, $event.target.value)"></td>
                                                        <td><input type="text" class="form-control" value="{{ $d->kedisiplinan }}" wire:change="saveKedisiplinan({{ $d->id }}, $event.target.value)"></td>
                                                    </tr>
                                                @empty
                                                    <tr>
                                                        <td colspan="100" class="text-center">
