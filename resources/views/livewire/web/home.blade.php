            ...
            <div class="col-xl-7 col-lg-7 col-sm-10 col-md-9 d-xl-flex d-lg-flex d-block align-items-center d-banner-tamim">
              ...
              <div class="banner-statics">
                <div class="single-statics">
                  <div class="part-icon">
                    <img src="{{ asset('assets/fe') }}/images/start.svg" alt="">
                  </div>
                  <div class="part-text">
                ...
                <div class="single-statics">
                  <div class="part-icon">
                    <img src="{{ asset('assets/fe') }}/images/user.svg" alt="">
                  </div>
                  <div class="part-text">
            ...
            <div class="col-xl-4 col-lg-5 col-sm-10 col-md-8 monitor-for-480">
              <div class="profit-calculator">
                <div class="calc-header">
                  <h3 class="title">Calculate <span class="special"> Your Profit</span>
                  </h3>
                </div>
                <div class="calc-body">
                  <div class="part-plan">
                    <h4 class="title"> Choose Mining Plan </h4>
                    <div class="dropdown show">
                      <a class="dropdown-toggle displayed-selected-plan" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 0.5% daily For 500 b. Days </a>
                  ...
                  <div class="part-amount">
                    ...
                    <form>
                      ...
                      <button class="dropdown-toggle displayed-selected-currency" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> USD </button>
                ...
                <div class="part-result">
                  <ul>
                    <li>
                      <div class="icon">
                        <img src="{{ asset('assets/fe') }}/images/business-and-finance.svg" alt="">
                      </div>
                      <div class="text">
                    ...
                    <li>
                      <div class="icon">
                        <img src="{{ asset('assets/fe') }}/images/profit.svg" alt="">
                      </div>
                      <div class="text">
                    ...
                    <li>
                      <div class="icon">
                        <img src="{{ asset('assets/fe') }}/images/profits.svg" alt="">
                      </div>
                      <div class="text">
                    ...
                    <li>
                      <div class="icon">
                        <img src="{{ asset('assets/fe') }}/images/return-on-investment.svg" alt="">
                      </div>
                      <div class="text">
            ...
            <div class="row justify-content-center justify-content-sm-center justify-content-md-start">
              <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
                <div class="single-system">
                  <div class="part-icon">
                    <img src="{{ asset('assets/fe') }}/images/add-user.svg" alt="">
                  </div>
                  <div class="part-text">
              ...
              <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
                <div class="single-system">
                  <div class="part-icon">
                    <img src="{{ asset('assets/fe') }}/images/coin.svg" alt="">
                  </div>
                  <div class="part-text">
              ...
              <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
                <div class="single-system">
                  <div class="part-icon">
                    <img src="{{ asset('assets/fe') }}/images/money-bag.svg" alt="">
                  </div>
                  <div class="part-text">
          ...
          <div class="row justify-content-xl-between justify-content-lg-between justify-content-md-between justify-content-sm-center">
            <div class="col-xl-6 col-lg-6 col-sm-10">
              <div class="part-text">
                ...
                <ul>
                  <li>
                    <i class="fas fa-check"></i> The standard chunk of Lorem Ipsum used since
                  </li>
                  <li>
                    <i class="fas fa-check"></i> reproduced below for those interested. Sections
                  </li>
                  <li>
                    <i class="fas fa-check"></i> de Finibus Bonorum et Malorum" by Cicero are also
                  </li>
                  <li>
                    <i class="fas fa-check"></i> reproduced in their exact original form
                  </li>
                </ul>
              ...
              <div class="part-feature">
                <div class="row">
                  <div class="col-xl-12 col-lg-12 col-sm-12 col-md-6">
                    <div class="single-feature">
                      <div class="feature-icon">
                        <img src="{{ asset('assets/fe') }}/images/solar-energy.svg" alt="">
                      </div>
                  ...
                  <div class="col-xl-12 col-lg-12 col-sm-12 col-md-6">
                    <div class="single-feature">
                      <div class="feature-icon">
                        <img src="{{ asset('assets/fe') }}/images/diploma.svg" alt="">
                      </div>
                      <div class="feature-text">
                  ...
                  <div class="col-xl-12 col-lg-12 col-sm-12 col-md-6">
                    <div class="single-feature">
                      <div class="feature-icon">
                        <img src="{{ asset('assets/fe') }}/images/blockchain.svg" alt="">
                      </div>
                      <div class="feature-text">
                  ...
                  <div class="col-xl-12 col-lg-12 col-sm-12 col-md-6">
                    <div class="single-feature">
                      <div class="feature-icon">
                        <img src="{{ asset('assets/fe') }}/images/worldwide.svg" alt="">
                      </div>
                      <div class="feature-text">
                        <h3>We're Global</h3>
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration </p>
          ...
          <div class="all-statics">
            <div class="row no-gutters justify-content-center">
              <div class="col-xl-4 col-lg-3 col-sm-10 col-md-4">
                <div class="single-statics">
                  <div class="part-img">
                    <img src="{{ asset('assets/fe') }}/images/investor.svg" alt="investor">
                  </div>
                  <div class="part-text">
              ...
              <div class="col-xl-4 col-lg-3 col-sm-10 col-md-4">
                <div class="single-statics">
                  <div class="part-img">
                    <img src="{{ asset('assets/fe') }}/images/withdraw.svg" alt="investor">
                  </div>
                  <div class="part-text">
              ...
              <div class="col-xl-4 col-lg-3 col-sm-10 col-md-4">
                <div class="single-statics">
                  <div class="part-img">
                    <img src="{{ asset('assets/fe') }}/images/money-transfering.svg" alt="investor">
                  </div>
                  <div class="part-text">
          ...
          <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-8">
              <div class="section-title">
                <span class="sub-title"> Premium Package </span>
                <h2> Check out Oitila's <span class="special">Pricing Plans!</span>
                </h2>
              </div>
            </div>
          </div>
          <div class="row justify-content-center justify-content-md-start">
            <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6 prc-col">
              <div class="single-plan">
                <h3>Basic Plan</h3>
                <div class="plan-icon">
                  <img src="{{ asset('assets/fe') }}/images/bronze-medal.png" alt="">
                </div>
                <div class="feature-list">
                  <ul>
                    <li>
                      <i class="fas fa-check"></i> Minimum Deposit $10
                    </li>
                    <li>
                      <i class="fas fa-check"></i> Miximum Deposit $10,000
                    </li>
                    <li>
                      <i class="fas fa-check"></i> l- Enhanced security
                    </li>
                    <li>
                      <i class="fas fa-check"></i> Access to all features
                    </li>
                    <li>
                      <i class="fas fa-check"></i> 24/7 dedicated support
                    </li>
                  </ul>
                </div>
                <div class="price-info">
                  <span class="parcent">$10</span>
                  <span class="price">99% <small>/per month</small>
                  </span>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6 prc-col">
              <div class="single-plan active">
                <h3>Standard Plan</h3>
                <div class="plan-icon">
                  <img src="{{ asset('assets/fe') }}/images/trophy-1.png" alt="">
                </div>
                <div class="feature-list">
                  <ul>
                    <li>
            ...
            <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6 prc-col">
              <div class="single-plan">
                <h3>Premium Plan</h3>
                <div class="plan-icon">
                  <img src="{{ asset('assets/fe') }}/images/trophy.png" alt="">
                </div>
                <div class="feature-list">
                  <ul>
                    <li>
            ...
            <div class="row justify-content-xl-between justify-content-lg-between justify-content-md-between justify-content-sm-center">
              ...
              <div class="col-xl-4 col-lg-4 d-xl-flex d-lg-flex justify-content-end d-block align-items-center">
                <div class="part-video">
                  <img src="{{ asset('assets/fe') }}/images/video.jpg" alt="">
                  <button data-video-id="L61p2uyiMSo" class="play-video js-video-button">
      ...
      <div class="team">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-8">
              <div class="section-title">
                <span class="sub-title"> Uppermost Investments </span>
                <h2> Meet with our <span class="special"> Top Investors</span>
                </h2>
              </div>
            </div>
          </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
              <div class="single-member">
                ...
                <div class="part-text">
                  ...
                  <div class="paid-from"> Paid from : <span class="paymethod-logo">
                      <img src="{{ asset('assets/fe') }}/images/bitcoin.png" alt="">
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="single-member">
                <div class="img-box">
                  <div class="part-img">
                    ...
                    <img src="{{ asset('assets/fe') }}/images/member-2.jpg" alt="">
                  </div>
                </div>
                <div class="part-text">
                  ...
                  <span class="invested-amount">Invested : $252.00k</span>
                  <div class="paid-from"> Paid from : <span class="paymethod-logo">
                      <img src="{{ asset('assets/fe') }}/images/litecoincoin.png" alt="">
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="single-member">
                <div class="img-box">
                  <div class="part-img">
                    ...
                    <img src="{{ asset('assets/fe') }}/images/member-3.jpg" alt="">
                  </div>
                </div>
                <div class="part-text">
          ...
          <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-8">
              <div class="section-title section-title-2">
                <span class="sub-title"> Must Meet With </span>
                <h2> Oitila's recent transaction </h2>
              </div>
            </div>
          </div>
          <div class="row justify-content-xl-between justify-content-lg-between justify-content-md-between justify-content-sm-center">
              ...
              <div class="transaction-list">
                <div class="Vertical-Slider">
                  <div class="single-transaction">
                    <div class="flag">
                      <img src="{{ asset('assets/fe') }}/images/flag-2.jpg" alt="">
                    </div>
                    <div class="user-info">
                    ...
                    <div class="coin">
                      <img src="{{ asset('assets/fe') }}/images/bitcoin.svg" alt="">
                    </div>
                  </div>
                  <div class="single-transaction">
                    <div class="flag">
                      <img src="{{ asset('assets/fe') }}/images/flag-3.jpg" alt="">
                    </div>
                    <div class="user-info">
                    ...
                    <div class="coin">
                      <img src="{{ asset('assets/fe') }}/images/ethereum.svg" alt="">
                    </div>
                  </div>
                  <div class="single-transaction">
                    <div class="flag">
                      <img src="{{ asset('assets/fe') }}/images/flag-4.jpg" alt="">
                    </div>
                    <div class="user-info">
                    ...
                    <div class="coin">
                      <img src="{{ asset('assets/fe') }}/images/litecoin.svg" alt="">
                    </div>
                  </div>
                  <div class="single-transaction">
                    <div class="flag">
            ...
            <div class="col-xl-6 col-lg-6 col-sm-10 col-md-12 d-xl-flex d-lg-flex d-block align-items-center">
              <div class="part-text">
                ...
                <p class="marked">
                  <b>Important:</b> Your Past Transactions list will show the past history in account activity on oitila. If you need information prior to the any year of the past, the statements will attach the past transaction history.
                </p>
      ...
      <div class="choosing-reason">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-8">
              <div class="section-title">
                <span class="sub-title"> You couldn't think </span>
                <h2> why oitila is <span class="special"> the best</span>
                </h2>
              </div>
            </div>
          </div>
          <div class="row justify-content-center">
                ...
                <div class="row">
                  <div class="col-xl-12 col-lg-12 col-md-4">
                    <div class="single-reason">
                      <div class="icon-box">
                        <div class="part-icon">
                          <img src="{{ asset('assets/fe') }}/images/withdraw.svg" alt="">
                        </div>
                      </div>
                      <div class="part-text">
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-4">
                    <div class="single-reason">
                      <div class="icon-box">
                        <div class="part-icon">
                          <img src="{{ asset('assets/fe') }}/images/referral.svg" alt="">
                        </div>
                      </div>
                      <div class="part-text">
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-4">
                    <div class="single-reason">
                      <div class="icon-box">
                        <div class="part-icon">
                          <img src="{{ asset('assets/fe') }}/images/affiliate-marketing.svg" alt="">
                        </div>
                      </div>
                      <div class="part-text">
            ...
            <div class="col-xl-4 col-lg-2 d-xl-flex d-lg-none d-block align-items-end">
              <div class="part-img">
                ...
                <img src="{{ asset('assets/fe') }}/images/choosing-reason.png" alt="">
              </div>
            </div>
            <div class="col-xl-4 col-lg-5 col-sm-10 col-md-12">
                ...
                <div class="row">
                  <div class="col-xl-12 col-lg-12 col-md-4">
                    <div class="single-reason">
                      <div class="icon-box">
                        <div class="part-icon">
                          <img src="{{ asset('assets/fe') }}/images/bird.svg" alt="">
                        </div>
                      </div>
                      <div class="part-text">
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-4">
                    <div class="single-reason">
                      <div class="icon-box">
                        <div class="part-icon">
                          <img src="{{ asset('assets/fe') }}/images/shield.svg" alt="">
                        </div>
                      </div>
                      <div class="part-text">
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-4">
                    <div class="single-reason">
                      <div class="icon-box">
                        <div class="part-icon">
                          <img src="{{ asset('assets/fe') }}/images/customer-service.svg" alt="">
                        </div>
                      </div>
                      <div class="part-text">
          ...
          <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-8">
              <div class="section-title">
                ...
                <h2> Clients are <span class="special"> happily Satisfied</span>
                </h2>
              </div>
            </div>
          </div>
              ...
              <div class="col-xl-8 col-lg-8">
                <div class="testi-text-slider">
                  <div class="single-testimonial">
                    <span class="quot-icon">
                      <img src="{{ asset('assets/fe') }}/images/quot.png" alt="">
                    </span>
                ...
                <div class="testi-user-slider">
                  <div class="single-user">
                    <img src="{{ asset('assets/fe') }}/images/testimonial.png" alt="">
                  </div>
                  <div class="single-user">
                    <img src="{{ asset('assets/fe') }}/images/testimonia-2.png" alt="">
                  </div>
                  <div class="single-user">
                    <img src="{{ asset('assets/fe') }}/images/testimonia-3.png" alt="">
                  </div>
                  <div class="single-user">
                    <img src="{{ asset('assets/fe') }}/images/testimonial.png" alt="">
                  </div>
          ...
          <div class="row justify-content-xl-between justify-content-lg-between justify-content-md-between justify-content-sm-center">
            ...
            <div class="col-xl-3 col-lg-3 col-sm-10 col-md-6">
              <div class="part-crypto">
                ...
                <div class="part-img">
                  <img src="{{ asset('assets/fe') }}/images/crypto-currency.png" alt="">
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="all-payment">
                ...
                <div class="gateway-slider">
                  <div class="single-payment-way">
                    <img src="{{ asset('assets/fe') }}/images/brand-1.jpg" alt="">
                  </div>
                  <div class="single-payment-way">
                    <img src="{{ asset('assets/fe') }}/images/brand-2.jpg" alt="">
                  </div>
                  <div class="single-payment-way">
                    <img src="{{ asset('assets/fe') }}/images/brand-4.jpg" alt="">
                  </div>
                  <div class="single-payment-way">
                    <img src="{{ asset('assets/fe') }}/images/brand-3.jpg" alt="">
                  </div>
                  <div class="single-payment-way">
                    <img src="{{ asset('assets/fe') }}/images/brand-5.jpg" alt="">
                  </div>
                  <div class="single-payment-way">
                    <img src="{{ asset('assets/fe') }}/images/brand-1.jpg" alt="">
                  </div>
      ...
      <div class="blog">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-8">
              <div class="section-title">
                <span class="sub-title"> Oitila Blogs News </span>
                <h2> Read Investment <span class="special"> News</span>
                </h2>
              </div>
            </div>
          </div>
          <div class="row justify-content-center justify-content-md-start">
            <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
              <div class="single-blog">
                <div class="part-img">
                  <img src="{{ asset('assets/fe') }}/images/blog-1.jpg" alt="">
                  <a href="#">
                    <i class="far fa-eye"></i>
                  </a>
                  <div class="post-date">
            ...
            <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
              <div class="single-blog">
                <div class="part-img">
                  <img src="{{ asset('assets/fe') }}/images/blog-2.jpg" alt="">
                  <a href="#"><i class="far fa-eye"></i>
                  </a>
                  <div class="post-date"><span class="date">26</span><span class="month">JAn</span>
                  </div>
                </div>
                <div class="part-text">
                  <a href="#" class="title">When coronavirus stops your league</a>
                  <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis sint esse vel atque asperiores eligendi vero blanditiis, totam eos beatae hic harum commodi quisquam debitis ipsam obcaecati deserunt nihil? Sed.</p>
                  <a href="#" class="share-btn"><i class="fas fa-share-alt"></i>
                  </a>
                </div>
              </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
              <div class="single-blog">
                <div class="part-img">
                  <img src="{{ asset('assets/fe') }}/images/blog-3.jpg" alt=""><a href="#"><i class="far fa-eye"></i></a><div class="post-date"><span class="date">26</span><span class="month">JAn</span></div>
                </div>
                <div class="part-text"><a href="#" class="title">When coronavirus stops your league</a><p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis sint esse vel atque asperiores eligendi vero blanditiis, totam eos beatae hic harum commodi quisquam debitis ipsam obcaecati deserunt nihil? Sed.</p><a href="#" class="share-btn"><i class="fas fa-share-alt"></i></a>
                </div>
              </div>
            </div>
          </div>
