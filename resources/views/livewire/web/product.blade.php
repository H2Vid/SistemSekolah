            ...
            <div class="row justify-content-center justify-content-md-start">
              <div class="col-xl-12 col-lg-12 col-sm-12 col-md-12">
                <div class="single-blog">
                  ...
                  <div class="part-text">
                    <a href="{{ url('/') }}/product/detail" class="title">When coronavirus stops your league</a>
            ...
            <div class="single-sidebar">
              ...
              <div class="popular-news">
                <div class="single-post">
                  <div>
                    <div class="part-img">
                      <img src="{{ asset('assets/fe') }}/images/popular-news-1.jpg" alt="">
                    </div>
                  </div>
                  <div class="part-text">
                ...
                <div class="single-post">
                  <div>
                    <div class="part-img">
                      <img src="{{ asset('assets/fe') }}/images/popular-news-2.jpg" alt="">
                    </div>
                  </div>
                  <div class="part-text">
                    <a href="#">How could the Premier League resume?</a>
                ...
                <div class="single-post">
                  <div>
                    <div class="part-img">
                      <img src="{{ asset('assets/fe') }}/images/popular-news-3.jpg" alt="">
                    </div>
                  </div>
                  <div class="part-text">
                    <a href="#">How could the Premier League resume?</a>
